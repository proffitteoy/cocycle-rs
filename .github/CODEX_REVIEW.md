...
| H1 and generic reduction | [F2 cohomology](../src/persistence/flag/cohomology/mod.rs), [generic dimensions/fields](../src/persistence/simplicial/cohomology.rs), [simplex order](../src/complex/simplicial/simplex.rs) | [optimization variants](../src/persistence/flag/cohomology/tests.rs), [independent high-dimensional reduction](../tests/rips_expansion.rs) |
| Sparse approximation | [blockers](../src/filtration/rips/approximation/blocker.rs), [sparse access](../src/filtration/rips/approximation/access.rs), [bound metadata](../src/filtration/rips/approximation/metadata.rs) | [sparse Rips](../tests/sparse_rips.rs) |
| Representative bases | [cycle basis](../src/persistence/simplicial/representatives/basis.rs), [dual solves](../src/persistence/simplicial/representatives/dual.rs) | [prime fields and independent basis checks](../tests/prime_fields.rs) |
